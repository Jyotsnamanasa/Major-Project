...
con1=connect('attendance.db')
cur1=con1.cursor()
cur1.execute("CREATE TABLE IF NOT EXISTS attendance(RollNumber text ,Name text NOT NULL,Branch text NOT NULL,Year text NOT NULL, mailid text NOT NULL,Day date NOT NULL,time timestamp not null,status text not null);")
con1.commit()
con1.close()
con1=connect('attendance_month.db')
cur1=con1.cursor()
